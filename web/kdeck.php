...
<main class="panel"><h2><?=h($active ?: 'No session')?></h2><div id="console" class="console"><div id="terminal"></div><pre id="fallback" class="fallback">loading...</pre></div>
